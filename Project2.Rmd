...
## Dimension Reduction
\footnotesize
If we cumulatively sum this vector of percentage contributions. using only the first five eigenvectors, we capture 89\% of variance. Using the first six eigenvectors, we capture 96\% of the variance. After that, the contributions taper off. Six eigenvectors is then a good number to include in our regression.
